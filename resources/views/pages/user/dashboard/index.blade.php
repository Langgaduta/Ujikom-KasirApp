            ...
            <div class="col-md-12">
                <div class="card shadow rounded-4 border-0">
                    <div class="card-body text-center">
                        ...
                        <h2 class="text-dark fw-bold mb-3">{{ $penjualanHariIni }}</h2> <!-- Variabel ini berisi total penjualan hari ini -->
                        <p class="card-text text-muted">Jumlah transaksi yang berhasil dilakukan hari ini</p>
                        <a href="{{ url('/user/penjualan') }}" class="btn btn-primary btn-sm">Lihat Detail</a>
